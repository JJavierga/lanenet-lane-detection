...
def init_args():
    ...
    parser.add_argument('-n','--folder_name', type=str, default='_instance', help='New folder name')
...
if __name__ == '__main__':
    ...
    new_dir = args.image_path + args.folder_name
    ...
    for file_name in os.listdir(args.image_path):
        ...
        if not(file_name==args.folder_name): 
