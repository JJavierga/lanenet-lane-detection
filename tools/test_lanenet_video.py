...
######
# python tools/test_lanenet_video.py --weights_path ./weights/tusimple_lanenet.ckpt --video_path /home/javier/Programming/Segmentation/ENet/ENet-Real-Time-Semantic-Segmentation/datasets/cars.mp4
######
